    ...
    <div class="card">
      ...
      <div class="card__body">
        ...
        <div v-else-if="transactionsStore.transactions.length === 0" class="text-center py-8">
          ...
          <button @click="showAddTransactionModal = true" class="btn btn--primary mt-4">
        ...
        <div v-else class="table-container">
          <table class="table table--striped">
            ...
            <tbody>
              <tr
                v-for="transaction in transactionsStore.paginatedTransactions"
                :key="transaction.id"
              >
        ...
        <div class="pagination">
          <div class="pagination__info">
            ...
            <span class="font-medium">{{
              (transactionsStore.currentPage - 1) * transactionsStore.itemsPerPage + 1
            }}</span>
            to
            <span class="font-medium">
              {{
                Math.min(
                  transactionsStore.currentPage * transactionsStore.itemsPerPage,
                  transactionsStore.totalItems,
                )
              }}
            </span>
            of
